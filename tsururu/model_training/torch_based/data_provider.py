...
class nnDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        if self.pipeline.multivariate:
            ...
            X_tensor_target_column = X_tensor_target_column.view(num_series, -1).T.flip(0)
            X_tensor_other_column = torch.repeat_interleave(X_tensor_other_column, X_tensor_target_column.size(0), dim=0)
